...
function contact() { "use strict"; contactCounter += 1;
    if (contactCounter % 2 === 1) {
        document.getElementById("contact").innerHTML = "<P><img src='img/Location.ico' width='30px' height='30px'> Location : <a href='https://goo.gl/maps/C6No6BxxBuE5zt7P8' target='_blank'>Giza</a><br><br><img src='img/Mobile.ico' width='35px' height='30px'>  Mobile : <a href='tel:+201220452267'>012220452267</a><br><br><img src='img/Email.ico' width='30px' height='30px'> Email :<a href='mailto:eng.micheal_fawzy@yahoo.com'>eng.micheal_fawzy@yahoo.com</a><br><br> <img src='img/Linkedin.ico' width='30px' height='30px'> Linkedin : <a href='https://www.linkedin.com/in/micheal-fawzy/' target='_blank'>/micheal-fawzy</a><br></p>";
